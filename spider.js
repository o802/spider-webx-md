...
if (deletedBy.includes(client.user.id) || sentBy.includes(client.user.id)) return;
    ...
    let notificationText = `░𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓 𝗔𝗡𝗧𝗜𝗗𝗘𝗟𝗘𝗧𝗘 𝗥𝗘𝗣𝗢𝗥𝗧░\n\n` +
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/254112011036?text=Hello👋+Spidey+Nihostie+Bot+Mkuu+😔',
                                mediaType: 1,
        ...
        try {
            ...
            await client.sendMessage(
                m.chat,
                {
                    ...
                    mimetype: "audio/mpeg",
		    caption: "𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓",
                    fileName: `${title}.mp3`,
                },
                { quoted: m }
            );
        ...
        async function redeployApp() {
            try {
                const response = await axios.post(
                    ...
                    {
                        source_blob: {
                            url: "https://github.com/spider660/spider-webx-md/tarball/main",
                        },
                    },
                    {
                        headers: {
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
    ...
    try {
        ...
        gis(text, async (error, results) => {
            ...
            const messages = imageUrls.map(url => ({
                image: { url },
                caption: `Downloaded by 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓`
            }));
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝐒𝐏𝐈𝐃𝐄𝐑 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝐒𝐏𝐈𝐃𝐄𝐑 [𝐒𝐏𝐈𝐃𝐄𝐑-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓'}, { quoted: m })
			}
			break;
...
//========================================================================================================================//		      
  ...
  let cap = `𝗖𝗢𝗡𝗩𝗘𝗥𝗧𝗘𝗗 𝗕𝗬 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓`;
...
const avatar = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/32zvqb.jpg');
const replies = "246";
const retweets = "125";
const theme = "dark";
...
//========================================================================================================================//		      
	      case "screenshot": case "ss": {
		      try {
let cap = `𝗦𝗰𝗿𝗲𝗲𝗻𝘀𝗵𝗼𝘁 𝗯𝘆 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓`
...
const cap = "𝐄𝐃𝐈𝐓𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓";
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    let fta = await uploadtoimgur(fdr)
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁,𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://files.catbox.moe/32zvqb.jpg')
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/32zvqb.jpg' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝐒𝐏𝐈𝐃𝐄𝐑*\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝐒𝐏𝐈𝐃𝐄𝐑`}); 
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝐒𝐏𝐈𝐃𝐄𝐑 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑-𝐁𝐎𝐓`,gifPlayback : false },{quoted : m}) 
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝐒𝐏𝐈𝐃𝐄𝐑-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m }); 
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(m.chat, { image: { url: imageUrl }, caption: `𝐑𝐄𝐓𝐑𝐈𝐄𝐕𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(m.chat, { video: { url: videoUrl }, caption: `𝐑𝐄𝐓𝐑𝐈𝐄𝐕𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
if (!m.quoted) return m.reply("quote a viewonce message eh")
  ...
  const quotedMessage = m.msg?.contextInfo?.quotedMessage;
    ...
    if (quotedMessage.imageMessage) {
      let imageCaption = quotedMessage.imageMessage.caption;
      let imageUrl = await client.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
      client.sendMessage(client.user.id, { image: { url: imageUrl }, caption: `𝐑𝐄𝐓𝐑𝐈𝐄𝐕𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑!\n${imageCaption}`}, { quoted: m });
    }

    if (quotedMessage.videoMessage) {
      let videoCaption = quotedMessage.videoMessage.caption;
      let videoUrl = await client.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
      client.sendMessage(client.user.id, { video: { url: videoUrl }, caption: `𝐑𝐄𝐓𝐑𝐈𝐄𝐕𝐄𝐃 𝐁𝐘 𝐒𝐏𝐈𝐃𝐄𝐑!\n${videoCaption}`}, { quoted: m });
    }
      }
	break;
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝐒𝐏𝐈𝐃𝐄𝐑 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
...
try {
        ...
        pp = 'https://files.catbox.moe/32zvqb.jpg';
      }
